...
export default function UserIdSetup() {
  const { userId, setSession, isDarkMode, showAlert, hasSeenOnboarding } =
    useSessionStore();
  ...
  const handleSave = async () => {
    if (!userIdService.validateId(inputValue)) {
      showAlert("Invalid ID format. Must be JobberFlow: include uuid", "error");
      return;
    }
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.header}>
            ...
            >
              Your User ID is used to identify you on our servers. It helps keep
              track of your API keys, job search details, and future persistent
              data securely.
            </Text>
          </View>
          ...
          <View style={[styles.card, isDarkMode && styles.darkCard]}>
            ...
            <TextInput
              ...
              placeholder="JobberFlow:your-unique-uuid"
            ...
            <View style={styles.actionRow}>
              <TouchableOpacity
                style={[
                  styles.actionButton,
                  isDarkMode && styles.darkActionButton,
                ]}
              ...
              >
                ...
                <Text
                  style={[
                    styles.actionText,
                    isDarkMode && styles.darkActionText,
                  ]}
                >
                  Generate
                </Text>
